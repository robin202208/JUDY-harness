- banner:
  ...
  - tablist:
    - tab "Chat" [selected]
    - tab "Trajectory"
- text: Use web_search to search exactly "JUDY snapshot search". Then reply exactly SEARCH_DONE and stop. {{clock}}
- button "Copy":
  - img
...
- button "Search JUDY snapshot search":
  - img
  - img
  - text: Search JUDY snapshot search
