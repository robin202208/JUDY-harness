...
export interface Config {
  ...
  tools?: ToolsConfig
  /** JUDY home directory exposed to bash and used for local skill discovery. */
  dshHome?: string
...
export interface Config {
  ...
  tools?: ToolsConfig
  /** JUDY home directory shared by shell context and local skill discovery. */
  dshHome?: string
...
export interface Config {
  /** JUDY home directory exposed as `DSH_HOME`; defaults to `$DSH_HOME` or `~/.dsh`. */
  dshHome?: string
}
```
...
export interface Config {
  ...
  /** JUDY config root. Defaults to `$DSH_HOME` or `~/.dsh`. */
  dshHome?: string
...
export interface Config {
  /** Include the fixed JUDY identity before the deployment persona (default true). */
