...
/** Directory name for the default JUDY home under the OS home. */
export const DSH_HOME_DIR_NAME = '.dsh'

/** Stable user-facing display form for the default JUDY home. */
export const DEFAULT_DSH_HOME_DISPLAY = `~/${DSH_HOME_DIR_NAME}`

/** Environment variable that overrides the default JUDY home. */
...
/**
 * Resolve the default JUDY home using Node's platform path rules.
...
/**
 * Resolve the single-root JUDY home.
 *
...
/**
 * Join path segments onto the resolved JUDY home.
