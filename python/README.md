...
Python packages for driving JUDY as a subprocess. The client SDK communicates with the bundled runtime over newline-delimited JSON-RPC on stdio.

## Packages

| Directory | Dist / module | Role |
|---|---|---|
| [sdk](sdk/README.md) | `judy-harness-sdk` / `judy_harness` | High-level turns API and lower-level JSON-RPC client |
| [sdk-runtime](sdk-runtime/README.md) | `judy-harness-runtime-bin` / `judy_harness_runtime` | Bundled runtime binaries and default agent configuration |
