...
const REPOSITORY_URL = 'https://github.com/robin202208/JUDY-harness'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/robin202208/JUDY-harness/${repositoryRef}/${path}${suffix}`
